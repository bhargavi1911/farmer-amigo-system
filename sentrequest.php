...
session_start();
  ...
  header('location:login.php');
    ...
    $cid = $_SESSION['cid'];
    $sql = "select itemrequest.*, farmer.* from itemrequest, farmer where cid='$cid' && itemrequest.fid=farmer.id";
...
<body>
	...
	<table class="table table-responsive table-striped rounded mb-5">
		<tr><th colspan="8" class="title" style="color:white">Sent item requests</th></tr>
